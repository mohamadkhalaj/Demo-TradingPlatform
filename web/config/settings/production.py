...
ALLOWED_HOSTS = env_.list("DJANGO_ALLOWED_HOSTS", default=["demoxchange.herokuapp.com"])
...
SECURE_SSL_REDIRECT = env_("DJANGO_SECURE_SSL_REDIRECT", default=True)
...
SECURE_HSTS_INCLUDE_SUBDOMAINS = env_("DJANGO_SECURE_HSTS_INCLUDE_SUBDOMAINS", default=True)
